/*
  ...
  This migration adds the USDT/ADA pair that was causing errors,
  along with other commonly used pairs to ensure the exchange
  calculator works properly.
  
  1. Data Addition
    - Add USDT/ADA and ADA/USDT pairs with correct rates
    - Add RUB/USDT pair for reverse calculations

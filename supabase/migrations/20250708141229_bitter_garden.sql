/*
  ...
  that matches the application's expectations.
  
  1. New Tables
    - `exchange_rates`
      - `id` (serial, primary key)
      - `currency_code` (text, not null) - The currency code (e.g., 'USDT', 'BTC')
      - `currency_name` (text, optional) - Full name of the currency
      - `sell` (numeric, not null) - Sell rate
      - `buy` (numeric, not null) - Buy rate
  ...
  3. Initial Data
    - Insert sample data for common cryptocurrencies
*/

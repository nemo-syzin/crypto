/*
  # Create User Account System Tables
  
  This migration creates the necessary tables for a comprehensive user account system:
  
  1. New Tables
    - `user_profiles` - Extended user profile information
    - `user_activity_logs` - Audit trail of user actions
    - `login_attempts` - Track failed login attempts for security
    - `verification_tokens` - Store verification tokens for email verification and password reset

/*
  # Add ADA/USDT pair and other missing pairs

  This migration adds the ADA/USDT pair and other commonly used pairs
  that might be missing from the database.
  
  1. Data Addition
    - Add ADA/USDT pair with realistic exchange rates
    - Add other commonly used pairs if they don't exist
...
-- Verify the data was inserted correctly
SELECT 
  'Added ADA/USDT and other pairs successfully' as status
FROM kenig_rates
WHERE source = 'kenig' AND base = 'ADA' AND quote = 'USDT';

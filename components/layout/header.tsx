  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-white/10 backdrop-blur-[10px] shadow-lg" : "bg-transparent backdrop-blur-[8px]"
      }`}
    >
      <div className="container mx-auto px-4 relative">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-12 absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
            <Link href="/exchange" className="text-[#001D8D] hover:opacity-80 transition-colors duration-200">
              Обмен
            </Link>

            <Link href="/rates" className="text-[#001D8D] hover:opacity-80 transition-colors duration-200">
              Курсы
            </Link>

            <Link href="/about" className="text-[#001D8D] hover:opacity-80 transition-colors duration-200">
              О нас
            </Link>
            ...
            <div className="relative">
              <button
                ...
                onClick={() => setPolicyDropdownOpen((v) => !v)}
                onBlur={(e) => {
              ...
              >
                Политика <ChevronDown className="h-4 w-4" />
              </button>
            ...
            <Link href="/support" className="text-[#001D8D] hover:opacity-80 transition-colors duration-200">
              Поддержка
            </Link>
          </nav>
          ...
          <div className="md:hidden">
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="text-[#001D8D] hover:bg-[#001D8D]/10">
              ...
              <SheetContent
                side="right"
                className="w-[300px] sm:w-[400px] bg-white/95 backdrop-blur-md border-[#001D8D]/20"
              >
                <SheetHeader>
                ...
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <div className="p-2 text-[#001D8D]">
                    <div className="mb-2 font-medium">Политика</div>
                  ...
                  <div className="border-t border-[#001D8D]/10 my-4 pt-4 flex flex-col gap-3">
                    ...
                    >
                      {theme === "dark" ? (
                        <>
                          <Sun className="h-4 w-4 mr-2" /> Светлая тема
                        </>
                      ) : (
                        <>
                          <Moon className="h-4 w-4 mr-2" /> Тёмная тема
                        </>
                      )}
                    </Button>
                    ...
                    <SheetClose asChild>
                      <Button asChild variant="ghost" className="text-[#001D8D] hover:bg-[#001D8D]/5">
                        {user ? <Link href="/dashboard">Личный кабинет</Link> : <Link href="/login">Вход</Link>}
                      </Button>
                    </SheetClose>

...
const benefits = [
  ...
  },
  {
    icon: Clock,
    title: "Скорость",
    description: "Работаем без выходных и максимально оперативно проводим сделки"
  },
  {
    icon: Globe,
    title: "Прозрачность",
    description: "Фиксированные условия сделки. Обновляем статус транзакции по вашему запросу"
  },
  {
    icon: CheckCircle,
    title: "Гарантия",
    description: "Окажем услугу или вернем деньги в течение 24 часов"
  }
];

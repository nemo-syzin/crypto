...
const services = [
  {
    ...
    description: "Помогаем спланировать получение средств в разных странах: разбираем доступные пути, инструменты и ограничения банков и платёжных сервисов, оцениваем риски и сроки.",
  },
  {
    icon: FileText,
    title: "Консультации по оплате инвойсов",
    description: "Разбираем варианты оплаты международных счетов — от ОАЭ до стран СНГ. Обсуждаем требования банков и платёжных провайдеров, формулировки назначений и необходимый пакет документов.",
  },
  {
    icon: Send,
    title: "Консультации по переводам за рубеж",
    description: "Обсуждаем способы пополнения зарубежных карт и счетов в Европе, Азии и СНГ. Помогаем оценить комиссии, сроки и регуляторные ограничения по каждому варианту.",
  },
  {
    icon: Wallet,
    title: "Консультации по пополнению платёжных систем",
    description: "PayPal, Zelle, WISE, Revolut, UnionPay, AliPay, WeChat и другие сервисы. Объясняем доступные способы пополнения, лимиты, комиссии и требования комплаенса.",
  }
];

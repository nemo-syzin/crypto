...
export function SupportPageClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Все комиссии уже включены в курс обмена. Мы не взимаем скрытых платежей. Итоговая сумма, которую вы видите при оформлении заявки, является финальной.",
      category: "Комиссии"
    },
    {
      question: "Нужна ли верификация для обмена?",
      answer: "Для небольших сумм верификация не требуется. Для крупных операций может потребоваться подтверждение личности в соответствии с требованиями AML/KYC.",
          ...
          <div className="space-y-24">
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-[#001D8D]/70 max-w-3xl mx-auto">
                  Мы собрали ответы на наиболее популярные вопросы, чтобы помочь вам быстро найти решение
                </p>
              </div>

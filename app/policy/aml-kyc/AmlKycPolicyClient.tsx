...
• Пользователь — физическое или иное лицо, использующее функционал Сервиса KenigSwap.`
    },
    {
      ...
      icon: AlertTriangle,
      content: `2.1. Отмывание денег — придание законного вида владению, пользованию или распоряжению денежными средствами или иным имуществом, полученными преступным путём (легализация доходов, полученных преступным путём).
...
2.3. Финансирование терроризма — предоставление финансовых средств или иной поддержки для совершения террористического акта, организация или оплата таких действий, а также финансирование и поддержка поездок лиц с целью участия в террористической деятельности.`
    },
    {
      ...
      icon: Scale,
      content: `3.1. KenigSwap стремится учитывать и соблюдать применимые международные и национальные нормы в сфере противодействия отмыванию денег и финансированию терроризма, включая рекомендации ФАТФ, а также требования законодательства соответствующих юрисдикций, в том числе Федерального закона РФ № 115-ФЗ.
...
3.4. Международные и местные нормы обязывают внедрять эффективные внутренние процедуры и механизмы для предотвращения отмывания денег, финансирования терроризма, торговли наркотиками и людьми, распространения оружия массового уничтожения, коррупции и других финансовых преступлений.`
    },
    {
      ...
      icon: Settings,
      content: `4.1. В рамках реализации настоящей Политики KenigSwap придерживается следующих принципов внутреннего контроля:
...
4.2. Система внутреннего контроля подлежит периодическому пересмотру. По мере изменения практики, законодательства или появления новых схем и рисков KenigSwap может обновлять процедуры и подходы в рамках AML/CTF.`
    },
    {
      ...
      icon: UserCheck,
      content: `5.1. Для координации применения настоящей Политики KenigSwap назначает ответственное лицо — комплаенс-офицера.
...
• информирует лиц, принимающих ключевые решения, о рисках, связанных с AML/CTF, и предлагает меры по их снижению.`
    },
    {
      ...
      icon: Users,
      content: `6.1. Лица, участвующие в работе Сервиса и имеющие отношение к проверке пользователей и/или обработке операций, должны быть информированы о рисках AML/CTF и основных требованиях настоящей Политики.
...
6.3. При существенных изменениях (новые нормативные требования, новые схемы отмывания средств и т.п.) KenigSwap может проводить дополнительный инструктаж.`
    },
    {
      ...
      icon: Search,
      content: `7.1. До предоставления доступа к отдельным функциям Сервиса KenigSwap может проводить процедуру надлежащей проверки пользователя — Customer Due Diligence (CDD).
...
• при необходимости учесть данные обстоятельства при оценке рисков и дальнейшем мониторинге.`
    },
    {
      ...
      icon: Activity,
      content: `8.1. KenigSwap применяет риск-ориентированный подход к мониторингу операций. Уровень и интенсивность контроля зависят от:
...
• при наличии оснований рассмотреть вопрос о подготовке сообщения о подозрительной операции в уполномоченный орган (если такие требования применимы).`
    },
    {
      ...
      icon: Archive,
      content: `9.1. Если применимое законодательство требует уведомлять уполномоченные органы о подозрительных операциях, KenigSwap может направлять соответствующие сообщения с учётом действующих требований.
...
9.3. KenigSwap стремится обеспечивать конфиденциальность и безопасность хранения таких сведений, предоставляя доступ к ним только уполномоченным лицам в объёме, необходимом для выполнения их задач в рамках AML/CTF и KYC.`
    },
    {
      ...
      icon: CheckCircle,
      content: `10.1. Для оценки эффективности применяемых мер KenigSwap может проводить внутреннюю проверку (аудит) соблюдения настоящей Политики.
...
• при появлении новых рисков и схем противоправной деятельности.`
    },
    {
      ...
      icon: Database,
      content: `11.1. По вопросам, связанным с применением настоящей Политики AML/CTF и KYC, пользователи могут обращаться в KenigSwap через доступные каналы связи, указанные в интерфейсе Сервиса (в том числе по адресу электронной почты, указанному для таких целей).
